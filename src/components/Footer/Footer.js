...
const Footer = () => (
  <footer className="ampstart-footer flex flex-column items-center p3">
    <ul className="ampstart-social-follow list-reset flex justify-around items-center flex-wrap m0 mb4">
      <li className="mr2">
        <a href="#" className="inline-block" alt="Link to AMP HTML Twitter">
      ...
      <li className="mr2">
        <a href="#" className="inline-block" alt="Link to AMP HTML Facebook">
      ...
      <li className="mr2">
        <a href="#" className="inline-block" alt="Link to AMP HTML pin trest">
      ...
      <li className="mr2">
        <a href="#" className="inline-block" alt="Link to AMP HTML E mail">
